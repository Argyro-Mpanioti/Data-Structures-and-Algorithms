...
public:
    ...
    void sortdeleted(int goneas); //Η συνάρτηση sortdeleted χρησιμοποιείται για την αντιμετάθεση στοιχείων του σωρού έτσι ώστε το στοιχείο goneas να βρίσκεται στη κατάλληλη θέση και το αντικείμενο να παραμείνει σωρός μεγίστων
};
